...
type ChallengeCardProps = {
  ...
  solved?: boolean;
  locked?: boolean;
  onStart?: (challenge: ChallengeSummary) => boolean;
};
...
export default function ChallengeCard({
  ...
  if (locked) {
    return (
      <div className="group relative flex h-full flex-col overflow-hidden rounded-xl border border-border bg-card opacity-60">
